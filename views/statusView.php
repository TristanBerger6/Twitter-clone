...
<head>
  ...
  <script src="./js/statusTweet.js" type="module" defer></script>
...
<body class="connected-page">
    ...
    <main class='homeContainer'>
        <div class="page-title flex">
            ...
            <a href="javascript:history.go()"><h1 class="fs-700">Tweet</h1></a>
        </div>
        ...
        <?php $i = 0;
                foreach($allAboveTweetsWInfos as $key=>$tweet){
                    ...
                    if($key === count($allAboveTweetsWInfos)-1){
                        ...
                        $tweet['date_hour_creation'] = strftime("%I:%M · %d %b %G",strtotime($tweet['date_hour_creation']));
        ...
        <?php 
            foreach($allCommentsWInfos as $tweet){
                ...
                require('includes/modalLikesInfos.php');
                require('includes/modalRetweetsInfos.php');
